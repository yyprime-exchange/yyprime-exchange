{
    "compilerOptions";
    {
        ...
        "es2016", /* Set the JavaScript language version for emitted JavaScript and include compatible library declarations. */
            "lib";
        ["dom", "es6"], /* Specify a set of bundled library declaration files that describe the target runtime environment. */
        ...
        true, /* Allow JavaScript files to be a part of your program. Use the `checkJS` option to get errors from these files. */
            ...
            "outDir";
        "build", /* Specify an output folder for all emitted files. */
    ...
    ["./src/**/*"],
        "exclude";
    ["./src/**/*.test.js", "node_modules", "**/node_modules"];
}
